...
detail_pois_gdf = gpd.read_file("detail_pois_2.geojson")
...
final_pois_gdf.to_file("final_pois_2.geojson", driver="GeoJSON")
print("Successfully processed and saved to final_pois_2.geojson")